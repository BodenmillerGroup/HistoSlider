...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutInfo = QtWidgets.QVBoxLayout(self.dockWidgetContentsInfo)
        ...
        self.dockWidgetSettings.setFeatures(QtWidgets.QDockWidget.AllDockWidgetFeatures)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons8-about-16.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAbout.setIcon(icon1)
        self.actionAbout.setObjectName("actionAbout")
        self.actionImportSlide = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons8-import-16.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportSlide.setIcon(icon2)
        self.actionImportSlide.setObjectName("actionImportSlide")
        self.actionOpenWorkspace = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons8-opened-folder-16.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dockWidgetInfo.setWindowTitle(_translate("MainWindow", "Info"))
